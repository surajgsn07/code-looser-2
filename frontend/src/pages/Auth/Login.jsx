    ...
    return (
        ...
        <div className='fixed  z-50  top-0 w-full bg-white dark:bg-stone-900'>
            ...
            <div className='p-4 bg-white dark:bg-stone-900   flex-1 w-full flex justify-center items-center'>
                ...
                >
                    <h1 className='text-center text-2xl font-bold text-gray-800 dark:text-gray-100 my-4'>Welcome Back 👋</h1>

                    <form className="w-full" onSubmit={(e) => handleSubmit(e)}>
                       
                        <input className='w-full my-2 p-2 px-3  outline-none rounded-md bg-gray-50 dark:bg-stone-800 dark:text-gray-50 ' 
                        type="email" autoComplete="off" onChange={handleChange} name="email" id="email" placeholder='Email' required/>
                    
                       <PasswordInp onChange={handleChange} placeholder={'Password'} name={'password'}/>
                        <Link to='/forgot/password' className='text-blue-800 text-xs px-2 font-semibold'>Forgot password ?</Link>
                        ...
                        <div className='text-center my-4 gap-1 flex items-center justify-center text-xs dark:text-gray-100'>Not Having Account? <Link to='/signup' className='text-blue-800 font-semibold'>SignUp here</Link> </div>
                    </form>
